  ...
  return (
    <PageTransition>
      <div className={styles.container}>
        <Head>
          <title>Sun City Summerlin Interactive Map | 55+ Community Las Vegas</title>
          <meta name="description" content="Explore Sun City Summerlin with our interactive map. View neighborhoods, amenities, golf courses, and property locations in this premier 55+ community in Las Vegas." />
          <meta name="keywords" content="Sun City Summerlin map, 55+ community Las Vegas map, Del Webb community map, senior living Las Vegas interactive map" />
          <link rel="canonical" href="https://suncitysummerlin.com/map" />
        </Head>
