...
export default function Zipcodes() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Sun City Summerlin Zipcodes | Las Vegas 55+ Community</title>
        <meta name="description" content="Explore Sun City Summerlin and surrounding area zipcodes. Find homes in 89134, 89135, 89138 and other nearby Las Vegas zipcodes with Dr. Jan Duffy, REALTOR®." />
