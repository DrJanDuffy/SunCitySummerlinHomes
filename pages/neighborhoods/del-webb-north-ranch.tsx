...
const DelWebbNorthRanch: NextPage = () => {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Del Webb North Ranch | 55+ Community in North Las Vegas</title>
        <meta name="description" content="Explore Del Webb North Ranch, a premier 55+ community in North Las Vegas offering luxury homes, resort-style amenities, and an active adult lifestyle." />
...
export default DelWebbNorthRanch;
