...
const Neighborhoods: NextPage = () => {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Las Vegas 55+ Communities & Neighborhoods | Dr. Jan Duffy</title>
        <meta name="description" content="Explore premier 55+ communities in Las Vegas, North Las Vegas, and Henderson with Dr. Jan Duffy, your local expert in active adult neighborhoods." />
