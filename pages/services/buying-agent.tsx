...
const BuyingAgentPage = () => {
  return (
    <PageTransition>
      <div className={styles.container}>
        <Head>
          <title>Buying Agent Services | Dr. Jan Duffy | Sun City Summerlin</title>
          <meta name="description" content="Expert buying agent services in Sun City Summerlin. Dr. Jan Duffy helps you find your perfect 55+ community home in Las Vegas with 25+ years of experience." />
        </Head>
...
export default BuyingAgentPage;
