  ...
  return (
    <PageTransition>
      <div className={styles.container}>
        <Head>
          <title>Relocation Services | Dr. Jan Duffy | Sun City Summerlin</title>
          <meta name="description" content="Specialized relocation services from California to Las Vegas. Dr. Jan Duffy helps you find your perfect home in Sun City Summerlin and other 55+ communities." />
        </Head>
