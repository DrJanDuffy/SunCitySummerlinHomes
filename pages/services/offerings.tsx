  ...
  return (
    <PageTransition>
      <div className={styles.container}>
        <Head>
          <title>Specialized Services | Dr. Jan Duffy | Sun City Summerlin</title>
          <meta name="description" content="Expert real estate services in Sun City Summerlin including buyer representation, luxury property sales, senior downsizing, veterans housing benefits, and HOA navigation." />
        </Head>
