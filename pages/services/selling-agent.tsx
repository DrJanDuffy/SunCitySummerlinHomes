...
const SellingAgentPage = () => {
  return (
    <PageTransition>
      <div className={styles.container}>
        <Head>
          <title>Selling Agent Services | Dr. Jan Duffy | Sun City Summerlin</title>
          <meta name="description" content="Expert selling agent services in Sun City Summerlin. Dr. Jan Duffy helps you sell your 55+ community home in Las Vegas with specialized marketing and negotiation." />
        </Head>
...
export default SellingAgentPage;
