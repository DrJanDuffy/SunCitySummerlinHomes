  ...
  return (
    <PageTransition>
      <div className={styles.container}>
        <Head>
          <title>Luxury Home Services | Dr. Jan Duffy | Sun City Summerlin</title>
          <meta name="description" content="Expert luxury home services in Sun City Summerlin. Dr. Jan Duffy specializes in golf course and premium properties in Las Vegas' premier 55+ community." />
        </Head>
