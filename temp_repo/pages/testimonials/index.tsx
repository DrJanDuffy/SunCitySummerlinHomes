  ...
  const testimonials = [
    {
      ...
      text: "Moving to Sun City Summerlin was the best decision we've made. Dr. Jan Duffy understood exactly what we were looking for and found us the perfect single-story home with mountain views. The community is vibrant and the amenities are outstanding!",
      rating: 5,
      date: "October 2023",
